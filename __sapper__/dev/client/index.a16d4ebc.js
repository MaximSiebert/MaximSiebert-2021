import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, g as detach_dev, h as claim_space, j as add_location, k as attr_dev, l as insert_dev, m as append_dev, n as set_data_dev, p as noop, q as validate_each_argument, r as create_component, u as query_selector_all, w as claim_component, x as mount_component, y as transition_in, z as transition_out, A as destroy_each, B as destroy_component } from './client.fa15b44d.js';
...
function create_fragment$1(ctx) {
	...
	let p1;
	let t4;
	let t5_value = new Date(/*updatedDate*/ ctx[0]) + "";
	let t5;
	let t6;
	let div2;
	let p2;
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p2, file$1, 56, 12, 1464);
			attr_dev(div2, "class", "flex justify-end w-full px-4 sm:w-4/12");
			add_location(div2, file$1, 55, 8, 1399);
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*updatedDate*/ 1 && t5_value !== (t5_value = new Date(/*updatedDate*/ ctx[0]) + "")) set_data_dev(t5, t5_value);
