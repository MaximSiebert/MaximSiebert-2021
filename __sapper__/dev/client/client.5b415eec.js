...
const components = [
	{
		js: () => Promise.all([import('./index.341ca8e4.js'), __inject_styles(["client-35408a35.css"])]).then(function(x) { return x[0]; })
	}
];
