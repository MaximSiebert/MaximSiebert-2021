import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, g as detach_dev, h as claim_space, j as add_location, k as attr_dev, l as insert_dev, m as append_dev, n as set_data_dev, p as noop, q as validate_each_argument, r as create_component, u as query_selector_all, w as claim_component, x as mount_component, y as transition_in, z as transition_out, A as destroy_each, B as destroy_component } from './client.b12c6a36.js';
...
function create_fragment$1(ctx) {
	...
	let t2;
	let t3;
	let t4_value = /*branchInfo*/ ctx[0].commit.commit.author.date + "";
	let t4;
	let t5;
	let div3;
	let div1;
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t6 = claim_text(p1_nodes, "Updated 05/2021");
			...
			t8 = claim_text(p2_nodes, "2011 – ");
			t9 = claim_text(p2_nodes, /*year*/ ctx[2]);
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*branchInfo*/ 1 && t4_value !== (t4_value = /*branchInfo*/ ctx[0].commit.commit.author.date + "")) set_data_dev(t4, t4_value);
			if (dirty & /*year*/ 4) set_data_dev(t9, /*year*/ ctx[2]);
		},
		i: noop,
		o: noop,
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$inject_state = $$props => {
		if ("branchInfo" in $$props) $$invalidate(0, branchInfo = $$props.branchInfo);
