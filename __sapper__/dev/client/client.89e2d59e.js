...
const components = [
	{
		js: () => Promise.all([import('./index.1379e56e.js'), __inject_styles(["client-2905d588.css"])]).then(function(x) { return x[0]; })
	}
];
