...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(pre, file, 21, 3, 530);
		},
		m: function mount(target, anchor) {
...
const components = [
	{
		js: () => Promise.all([import('./index.472c26f6.js'), __inject_styles(["client-e62db579.css"])]).then(function(x) { return x[0]; })
	}
];
