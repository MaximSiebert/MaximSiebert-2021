...
const components = [
	{
		js: () => Promise.all([import('./index.60e0bb80.js'), __inject_styles(["client-35408a35.css"])]).then(function(x) { return x[0]; })
	}
];
