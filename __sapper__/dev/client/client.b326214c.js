...
const components = [
	{
		js: () => Promise.all([import('./index.f87ee9ef.js'), __inject_styles(["client-b8aceb23.css"])]).then(function(x) { return x[0]; })
	}
];
