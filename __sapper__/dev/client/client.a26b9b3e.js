...
const components = [
	{
		js: () => Promise.all([import('./index.f409f2cd.js'), __inject_styles(["client-a61f71ff.css"])]).then(function(x) { return x[0]; })
	}
];
