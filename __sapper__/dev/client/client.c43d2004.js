...
const components = [
	{
		js: () => Promise.all([import('./index.b67eca2f.js'), __inject_styles(["client-6979b1e4.css"])]).then(function(x) { return x[0]; })
	}
];
