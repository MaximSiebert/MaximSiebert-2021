...
const components = [
	{
		js: () => Promise.all([import('./index.ccc1676f.js'), __inject_styles(["client-ed7a5a14.css"])]).then(function(x) { return x[0]; })
	}
];
