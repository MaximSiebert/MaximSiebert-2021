...
const components = [
	{
		js: () => Promise.all([import('./index.ddea9f9e.js'), __inject_styles(["client-f932bf1c.css"])]).then(function(x) { return x[0]; })
	}
];
