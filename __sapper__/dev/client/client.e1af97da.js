...
const components = [
	{
		js: () => Promise.all([import('./index.f4b45d3b.js'), __inject_styles(["client-6979b1e4.css"])]).then(function(x) { return x[0]; })
	}
];
