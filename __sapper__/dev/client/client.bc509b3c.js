...
const components = [
	{
		js: () => Promise.all([import('./index.70d38bb1.js'), __inject_styles(["client-700d8d59.css"])]).then(function(x) { return x[0]; })
	}
];
