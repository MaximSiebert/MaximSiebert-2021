...
const components = [
	{
		js: () => Promise.all([import('./index.1a9c58c6.js'), __inject_styles(["client-6979b1e4.css"])]).then(function(x) { return x[0]; })
	}
];
