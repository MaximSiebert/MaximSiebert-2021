...
const components = [
	{
		js: () => Promise.all([import('./index.9cc5e5e2.js'), __inject_styles(["client-b941cf2e.css"])]).then(function(x) { return x[0]; })
	}
];
