...
const components = [
	{
		js: () => Promise.all([import('./index.4cb9a981.js'), __inject_styles(["client-5da4c034.css"])]).then(function(x) { return x[0]; })
	}
];
