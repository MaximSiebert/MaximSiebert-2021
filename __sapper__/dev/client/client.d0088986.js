...
const components = [
	{
		js: () => Promise.all([import('./index.5d053edb.js'), __inject_styles(["client-a61f71ff.css"])]).then(function(x) { return x[0]; })
	}
];
