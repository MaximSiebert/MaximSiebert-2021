...
const components = [
	{
		js: () => Promise.all([import('./index.e35b2740.js'), __inject_styles(["client-a61f71ff.css"])]).then(function(x) { return x[0]; })
	}
];
