...
const components = [
	{
		js: () => Promise.all([import('./index.009ac8e9.js'), __inject_styles(["client-b941cf2e.css"])]).then(function(x) { return x[0]; })
	}
];
