...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$1, 22, 1, 422);
			add_location(main, file$1, 20, 0, 397);
		},
...
const components = [
	{
		js: () => Promise.all([import('./index.c295d2e0.js'), __inject_styles(["client-4b703a29.css"])]).then(function(x) { return x[0]; })
	}
];
