...
// (57:16) {:then updatedDate}
function create_then_block(ctx) {
	let t0_value = /*monthNames*/ ctx[2][new Date(/*updatedDate*/ ctx[3]).getMonth()] + "";
	let t0;
	let t1;
	let t2_value = new Date(/*updatedDate*/ ctx[3]).getFullYear() + "";
	let t2;
...
function create_fragment$1(ctx) {
	...
	handle_promise(/*updatedDate*/ ctx[3], info);
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p2, file$1, 62, 12, 1759);
			attr_dev(div2, "class", "flex justify-end w-full px-4 sm:w-4/12");
			add_location(div2, file$1, 61, 8, 1694);
...
function instance$1($$self, $$props, $$invalidate) {
	...
	return [time, year, monthNames, updatedDate];
}
