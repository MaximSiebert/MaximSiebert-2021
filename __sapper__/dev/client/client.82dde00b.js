...
const components = [
	{
		js: () => Promise.all([import('./index.79300074.js'), __inject_styles(["client-2905d588.css"])]).then(function(x) { return x[0]; })
	}
];
