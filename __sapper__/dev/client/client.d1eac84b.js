...
const components = [
	{
		js: () => Promise.all([import('./index.a52bbe41.js'), __inject_styles(["client-b8aceb23.css"])]).then(function(x) { return x[0]; })
	}
];
