...
const components = [
	{
		js: () => Promise.all([import('./index.9c5b3634.js'), __inject_styles(["client-a61f71ff.css"])]).then(function(x) { return x[0]; })
	}
];
