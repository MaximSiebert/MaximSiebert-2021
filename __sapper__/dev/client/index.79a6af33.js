...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file, 83, 6, 2938);
			attr_dev(div0, "class", "w-4/12 px-4");
			add_location(div0, file, 82, 5, 2906);
			add_location(p1, file, 86, 6, 3026);
			attr_dev(div1, "class", "hidden w-4/12 px-4 sm:block");
			add_location(div1, file, 85, 5, 2978);
			add_location(p2, file, 89, 6, 3124);
			attr_dev(div2, "class", "flex justify-end w-8/12 px-4 sm:w-4/12");
			add_location(div2, file, 88, 5, 3065);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file, 113, 6, 3846);
			attr_dev(div0, "class", "w-4/12 px-4");
			add_location(div0, file, 112, 5, 3814);
			add_location(p1, file, 116, 6, 3937);
			attr_dev(div1, "class", "hidden w-4/12 px-4 sm:block");
			add_location(div1, file, 115, 5, 3889);
			add_location(p2, file, 119, 6, 4038);
			attr_dev(div2, "class", "flex justify-end w-8/12 px-4 sm:w-4/12");
			add_location(div2, file, 118, 5, 3979);
			attr_dev(a, "class", "flex block ml-auto text-gray-600 dark:text-gray-400 hover:underline hover:text-black dark:hover:text-white");
			attr_dev(a, "href", a_href_value = /*experience*/ ctx[6].url);
			attr_dev(a, "target", "_blank");
			attr_dev(a, "rel", "noreferrer noopener");
			add_location(a, file, 111, 4, 3624);
		},
		m: function mount(target, anchor) {
			insert_dev(target, a, anchor);
			append_dev(a, div0);
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			header0 = claim_element(div20_nodes, "HEADER", { class: true });
			...
			section0 = claim_element(div20_nodes, "SECTION", { class: true });
			...
			header1 = claim_element(div20_nodes, "HEADER", { class: true });
			...
			section1 = claim_element(div20_nodes, "SECTION", { class: true });
			...
			t19 = claim_text(div14_nodes, " Ottawa – ");
			t20 = claim_text(div14_nodes, /*time*/ ctx[2]);
			t21 = claim_text(div14_nodes, " ET");
			...
			t23 = claim_text(p6_nodes, "Updated 05/2021");
			p6_nodes.forEach(detach_dev);
			div16_nodes.forEach(detach_dev);
			t24 = claim_space(div18_nodes);
			div17 = claim_element(div18_nodes, "DIV", { class: true });
			var div17_nodes = children(div17);
			p7 = claim_element(div17_nodes, "P", {});
			var p7_nodes = children(p7);
			t25 = claim_text(p7_nodes, "© 2011 – ");
			t26 = claim_text(p7_nodes, /*year*/ ctx[3]);
		...
		h: function hydrate() {
			...
			add_location(div6, file, 76, 2, 2536);
			attr_dev(div7, "class", "w-full ml-auto md:w-8/12");
			add_location(div7, file, 79, 2, 2645);
			attr_dev(section0, "class", "flex flex-wrap mb-8 md:mb-12");
			add_location(section0, file, 75, 1, 2487);
			add_location(p3, file, 98, 4, 3306);
			attr_dev(div8, "class", "w-4/12 px-4");
			add_location(div8, file, 97, 3, 3276);
			add_location(p4, file, 101, 4, 3383);
			attr_dev(div9, "class", "hidden w-4/12 px-4 sm:block");
			add_location(div9, file, 100, 3, 3337);
			add_location(p5, file, 104, 4, 3466);
			attr_dev(div10, "class", "flex justify-end w-8/12 px-4 sm:w-4/12");
			add_location(div10, file, 103, 3, 3409);
			attr_dev(div11, "class", "flex w-full ml-auto md:w-8/12");
			add_location(div11, file, 96, 2, 3229);
			attr_dev(header1, "class", "flex mb-2");
			add_location(header1, file, 95, 1, 3200);
			attr_dev(div12, "class", "w-full ml-auto md:w-8/12");
			add_location(div12, file, 109, 2, 3544);
			attr_dev(section1, "class", "flex flex-wrap");
			add_location(section1, file, 108, 1, 3509);
			attr_dev(div13, "class", "loader");
			add_location(div13, file, 127, 8, 4237);
			add_location(div14, file, 127, 3, 4232);
			attr_dev(div15, "class", "w-8/12 px-4 sm:w-3/12");
			add_location(div15, file, 126, 2, 4193);
			add_location(p6, file, 131, 4, 4393);
			attr_dev(div16, "class", "hidden w-8/12 px-4 sm:block");
			add_location(div16, file, 130, 3, 4347);
			add_location(p7, file, 134, 4, 4486);
			attr_dev(div17, "class", "flex justify-end w-full px-4 sm:w-4/12");
			add_location(div17, file, 133, 3, 4429);
			attr_dev(div18, "class", "flex w-4/12 ml-auto sm:w-8/12");
			add_location(div18, file, 129, 2, 4300);
			attr_dev(div19, "class", "flex pt-8 mt-auto text-gray-600 md:pt-12 dark:text-gray-400");
			add_location(div19, file, 125, 1, 4117);
			attr_dev(div20, "class", "flex flex-col min-h-screen py-4 text-xs bg-gray-100 lg:py-8 lg:px-4 dark:bg-black dark:text-white");
			add_location(div20, file, 55, 0, 1816);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, div20, anchor);
			append_dev(div20, header0);
