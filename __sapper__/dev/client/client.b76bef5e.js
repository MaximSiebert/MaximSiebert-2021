...
const components = [
	{
		js: () => Promise.all([import('./index.18c53d8b.js'), __inject_styles(["client-5da4c034.css"])]).then(function(x) { return x[0]; })
	}
];
