...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(pre, file, 21, 3, 548);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "block px-4 mb-5 loader hover:underline");
			add_location(a, file, 13, 1, 283);
			attr_dev(h1, "class", "mb-1 sm:mb-2");
			add_location(h1, file, 15, 2, 369);
			attr_dev(p, "class", "text-gray-600 dark:text-gray-400");
			add_location(p, file, 16, 2, 410);
			attr_dev(div0, "class", "px-4");
			add_location(div0, file, 14, 1, 348);
...
const components = [
	{
		js: () => Promise.all([import('./index.c0caa73a.js'), __inject_styles(["client-6979b1e4.css"])]).then(function(x) { return x[0]; })
	}
];
