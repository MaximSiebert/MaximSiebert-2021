...
const components = [
	{
		js: () => Promise.all([import('./index.909f6c24.js'), __inject_styles(["client-4b703a29.css"])]).then(function(x) { return x[0]; })
	}
];
