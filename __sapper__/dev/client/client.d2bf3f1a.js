...
const components = [
	{
		js: () => Promise.all([import('./index.1acd134a.js'), __inject_styles(["client-35408a35.css"])]).then(function(x) { return x[0]; })
	}
];
