...
const components = [
	{
		js: () => Promise.all([import('./index.9fd696ca.js'), __inject_styles(["client-6979b1e4.css"])]).then(function(x) { return x[0]; })
	}
];
