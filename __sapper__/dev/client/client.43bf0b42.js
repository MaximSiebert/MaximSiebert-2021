...
const components = [
	{
		js: () => Promise.all([import('./index.8dfe0d7d.js'), __inject_styles(["client-b941cf2e.css"])]).then(function(x) { return x[0]; })
	}
];
