...
const components = [
	{
		js: () => Promise.all([import('./index.6893159a.js'), __inject_styles(["client-5da4c034.css"])]).then(function(x) { return x[0]; })
	}
];
