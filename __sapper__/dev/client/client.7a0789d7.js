...
const components = [
	{
		js: () => Promise.all([import('./index.ba4ab14a.js'), __inject_styles(["client-b8aceb23.css"])]).then(function(x) { return x[0]; })
	}
];
