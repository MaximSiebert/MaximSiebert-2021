...
const components = [
	{
		js: () => Promise.all([import('./index.1de37d81.js'), __inject_styles(["client-35408a35.css"])]).then(function(x) { return x[0]; })
	}
];
