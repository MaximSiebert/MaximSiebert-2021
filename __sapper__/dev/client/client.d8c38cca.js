...
const components = [
	{
		js: () => Promise.all([import('./index.50d0d8cd.js'), __inject_styles(["client-b941cf2e.css"])]).then(function(x) { return x[0]; })
	}
];
