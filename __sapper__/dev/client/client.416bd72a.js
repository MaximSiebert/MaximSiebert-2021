...
const components = [
	{
		js: () => Promise.all([import('./index.7686a81d.js'), __inject_styles(["client-74ac5965.css"])]).then(function(x) { return x[0]; })
	}
];
