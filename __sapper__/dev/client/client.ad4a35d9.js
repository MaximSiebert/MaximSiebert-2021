...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ GlobalStyle });
	return [$$scope, slots];
}
...
const components = [
	{
		js: () => Promise.all([import('./index.cee3085c.js'), __inject_styles(["client-4b703a29.css"])]).then(function(x) { return x[0]; })
	}
];
