...
const components = [
	{
		js: () => Promise.all([import('./index.ee103f9f.js'), __inject_styles(["client-4b703a29.css"])]).then(function(x) { return x[0]; })
	}
];
