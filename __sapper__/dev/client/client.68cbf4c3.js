...
const components = [
	{
		js: () => Promise.all([import('./index.a5c5c6e6.js'), __inject_styles(["client-a61f71ff.css"])]).then(function(x) { return x[0]; })
	}
];
