import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, g as detach_dev, h as claim_space, j as add_location, k as attr_dev, l as insert_dev, m as append_dev, n as set_data_dev, p as noop, q as validate_each_argument, r as create_component, u as query_selector_all, w as claim_component, x as mount_component, y as transition_in, z as transition_out, A as destroy_each, B as destroy_component } from './client.d34fc1c3.js';
...
function create_fragment$1(ctx) {
	...
	let p1;
	let t4;
	let t5_value = /*monthNames*/ ctx[3][new Date(/*updatedDate*/ ctx[0]).getMonth()] + "";
	let t5;
	let t6;
	let t7_value = new Date(/*updatedDate*/ ctx[0]).getFullYear() + "";
	let t7;
	let t8;
	let div2;
	let p2;
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t10 = claim_text(p2_nodes, /*year*/ ctx[2]);
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*updatedDate*/ 1 && t5_value !== (t5_value = /*monthNames*/ ctx[3][new Date(/*updatedDate*/ ctx[0]).getMonth()] + "")) set_data_dev(t5, t5_value);
			if (dirty & /*updatedDate*/ 1 && t7_value !== (t7_value = new Date(/*updatedDate*/ ctx[0]).getFullYear() + "")) set_data_dev(t7, t7_value);
			if (dirty & /*year*/ 4) set_data_dev(t10, /*year*/ ctx[2]);
		},
		i: noop,
		o: noop,
