...
const components = [
	{
		js: () => Promise.all([import('./index.a0a5738d.js'), __inject_styles(["client-e62db579.css"])]).then(function(x) { return x[0]; })
	}
];
