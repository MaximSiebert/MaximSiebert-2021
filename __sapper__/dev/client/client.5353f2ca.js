...
const components = [
	{
		js: () => Promise.all([import('./index.e3e66072.js'), __inject_styles(["client-ed7a5a14.css"])]).then(function(x) { return x[0]; })
	}
];
