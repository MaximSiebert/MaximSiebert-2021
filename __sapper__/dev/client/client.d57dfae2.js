...
const components = [
	{
		js: () => Promise.all([import('./index.9069ee4c.js'), __inject_styles(["client-4b703a29.css"])]).then(function(x) { return x[0]; })
	}
];
