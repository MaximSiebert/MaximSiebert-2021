...
const components = [
	{
		js: () => Promise.all([import('./index.f3b03dc4.js'), __inject_styles(["client-a61f71ff.css"])]).then(function(x) { return x[0]; })
	}
];
