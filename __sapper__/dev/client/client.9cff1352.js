...
const components = [
	{
		js: () => Promise.all([import('./index.0e25ab45.js'), __inject_styles(["client-a61f71ff.css"])]).then(function(x) { return x[0]; })
	}
];
