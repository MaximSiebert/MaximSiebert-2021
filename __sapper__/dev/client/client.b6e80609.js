...
const components = [
	{
		js: () => Promise.all([import('./index.01ff3c42.js'), __inject_styles(["client-e62db579.css"])]).then(function(x) { return x[0]; })
	}
];
