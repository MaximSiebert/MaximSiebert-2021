...
const components = [
	{
		js: () => Promise.all([import('./index.9f4efdeb.js'), __inject_styles(["client-5da4c034.css"])]).then(function(x) { return x[0]; })
	}
];
