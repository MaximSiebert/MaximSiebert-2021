...
const components = [
	{
		js: () => Promise.all([import('./index.cc31600a.js'), __inject_styles(["client-e62db579.css"])]).then(function(x) { return x[0]; })
	}
];
