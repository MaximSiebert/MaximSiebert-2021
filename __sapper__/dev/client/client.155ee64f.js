...
const components = [
	{
		js: () => Promise.all([import('./index.7daa56c0.js'), __inject_styles(["client-a61f71ff.css"])]).then(function(x) { return x[0]; })
	}
];
