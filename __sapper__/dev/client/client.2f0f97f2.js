...
const components = [
	{
		js: () => Promise.all([import('./index.0e5afbc4.js'), __inject_styles(["client-cdb134d6.css"])]).then(function(x) { return x[0]; })
	}
];
