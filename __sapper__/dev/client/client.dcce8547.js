...
const components = [
	{
		js: () => Promise.all([import('./index.a1240ea7.js'), __inject_styles(["client-2905d588.css"])]).then(function(x) { return x[0]; })
	}
];
