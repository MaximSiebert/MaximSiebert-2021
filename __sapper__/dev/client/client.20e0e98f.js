...
const components = [
	{
		js: () => Promise.all([import('./index.1f4aa0f8.js'), __inject_styles(["client-4b703a29.css"])]).then(function(x) { return x[0]; })
	}
];
