...
const components = [
	{
		js: () => Promise.all([import('./index.b9c2bb2b.js'), __inject_styles(["client-4b703a29.css"])]).then(function(x) { return x[0]; })
	}
];
