...
const components = [
	{
		js: () => Promise.all([import('./index.b54c4afa.js'), __inject_styles(["client-a61f71ff.css"])]).then(function(x) { return x[0]; })
	}
];
