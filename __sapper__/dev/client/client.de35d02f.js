...
const components = [
	{
		js: () => Promise.all([import('./index.e38879e8.js'), __inject_styles(["client-ba3b4a0d.css"])]).then(function(x) { return x[0]; })
	}
];
