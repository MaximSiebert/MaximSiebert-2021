...
const components = [
	{
		js: () => Promise.all([import('./index.de097b7c.js'), __inject_styles(["client-ba3b4a0d.css"])]).then(function(x) { return x[0]; })
	}
];
