...
const components = [
	{
		js: () => Promise.all([import('./index.b626b3e8.js'), __inject_styles(["client-5da4c034.css"])]).then(function(x) { return x[0]; })
	}
];
