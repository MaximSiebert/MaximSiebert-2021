...
const components = [
	{
		js: () => Promise.all([import('./index.eda16d84.js'), __inject_styles(["client-700d8d59.css"])]).then(function(x) { return x[0]; })
	}
];
