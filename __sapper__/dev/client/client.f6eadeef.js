...
const components = [
	{
		js: () => Promise.all([import('./index.18315db5.js'), __inject_styles(["client-f932bf1c.css"])]).then(function(x) { return x[0]; })
	}
];
