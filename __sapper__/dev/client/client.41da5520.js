...
const components = [
	{
		js: () => Promise.all([import('./index.1c11df4f.js'), __inject_styles(["client-6979b1e4.css"])]).then(function(x) { return x[0]; })
	}
];
