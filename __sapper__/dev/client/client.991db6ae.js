...
const components = [
	{
		js: () => Promise.all([import('./index.0d6661e8.js'), __inject_styles(["client-30818844.css"])]).then(function(x) { return x[0]; })
	}
];
