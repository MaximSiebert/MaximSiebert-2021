...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(pre, file, 21, 3, 532);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "block px-4 mb-5 loader");
			...
			add_location(p, file, 16, 2, 394);
			attr_dev(div0, "class", "px-4");
			add_location(div0, file, 14, 1, 332);
...
const components = [
	{
		js: () => Promise.all([import('./index.731582e9.js'), __inject_styles(["client-6979b1e4.css"])]).then(function(x) { return x[0]; })
	}
];
