...
const components = [
	{
		js: () => Promise.all([import('./index.ab3a36ab.js'), __inject_styles(["client-f932bf1c.css"])]).then(function(x) { return x[0]; })
	}
];
