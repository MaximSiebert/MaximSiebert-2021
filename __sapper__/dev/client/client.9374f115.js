...
const components = [
	{
		js: () => Promise.all([import('./index.62b9a7d9.js'), __inject_styles(["client-f932bf1c.css"])]).then(function(x) { return x[0]; })
	}
];
