import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, o as onMount, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, g as detach_dev, h as claim_space, j as add_location, k as attr_dev, l as insert_dev, m as append_dev, n as set_data_dev, p as noop, q as validate_each_argument, r as create_component, u as query_selector_all, w as claim_component, x as mount_component, y as transition_in, z as transition_out, A as destroy_each, B as destroy_component } from './client.89435cc8.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file$1, 49, 8, 1201);
			attr_dev(div0, "class", "w-8/12 px-4 sm:w-3/12");
			add_location(div0, file$1, 48, 4, 1157);
			add_location(p1, file$1, 53, 12, 1348);
			attr_dev(div1, "class", "hidden w-8/12 px-4 sm:block");
			add_location(div1, file$1, 52, 8, 1294);
...
function instance$1($$self, $$props, $$invalidate) {
	...
	onMount(async () => {
		fetch(`https://api.github.com/repos/MaximSiebert/MaximSiebert-2021/branches/gh-pages`, {
			...
			$$invalidate(0, updatedDate = data.commit.commit.author.date.getHours());
		});
	});
