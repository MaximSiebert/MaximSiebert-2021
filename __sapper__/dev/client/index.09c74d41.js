...
function create_then_block(ctx) {
	...
	let t0;
	let t1;
	let t2_value = new Date(/*data*/ ctx[5]).getFullYear() + "";
	let t2;
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p2, file$1, 62, 12, 1738);
			attr_dev(div2, "class", "flex justify-end w-full px-4 sm:w-4/12");
			add_location(div2, file$1, 61, 8, 1673);
