...
const components = [
	{
		js: () => Promise.all([import('./index.300b06a3.js'), __inject_styles(["client-b8aceb23.css"])]).then(function(x) { return x[0]; })
	}
];
