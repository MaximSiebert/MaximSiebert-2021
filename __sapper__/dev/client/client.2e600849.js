...
const components = [
	{
		js: () => Promise.all([import('./index.0b0ad060.js'), __inject_styles(["client-2cc70a0c.css"])]).then(function(x) { return x[0]; })
	}
];
