...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file, 83, 6, 2932);
			attr_dev(div0, "class", "w-4/12 px-4");
			add_location(div0, file, 82, 5, 2900);
			add_location(p1, file, 86, 6, 3020);
			attr_dev(div1, "class", "hidden w-4/12 px-4 sm:block");
			add_location(div1, file, 85, 5, 2972);
			add_location(p2, file, 89, 6, 3118);
			attr_dev(div2, "class", "flex justify-end w-8/12 px-4 sm:w-4/12");
			add_location(div2, file, 88, 5, 3059);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file, 113, 6, 3840);
			attr_dev(div0, "class", "w-4/12 px-4");
			add_location(div0, file, 112, 5, 3808);
			add_location(p1, file, 116, 6, 3931);
			attr_dev(div1, "class", "hidden w-4/12 px-4 sm:block");
			add_location(div1, file, 115, 5, 3883);
			add_location(p2, file, 119, 6, 4032);
			attr_dev(div2, "class", "flex justify-end w-8/12 px-4 sm:w-4/12");
			add_location(div2, file, 118, 5, 3973);
			attr_dev(a, "class", "flex block ml-auto text-gray-600 dark:text-gray-400 hover:underline hover:text-black dark:hover:text-white");
			attr_dev(a, "href", a_href_value = /*experience*/ ctx[6].url);
			attr_dev(a, "target", "_blank");
			attr_dev(a, "rel", "noreferrer noopener");
			add_location(a, file, 111, 4, 3618);
		},
		m: function mount(target, anchor) {
			insert_dev(target, a, anchor);
			append_dev(a, div0);
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div6, file, 76, 2, 2530);
			attr_dev(div7, "class", "w-full ml-auto md:w-8/12");
			add_location(div7, file, 79, 2, 2639);
			attr_dev(section0, "class", "flex flex-wrap mb-8 md:mb-12");
			add_location(section0, file, 75, 1, 2481);
			add_location(p3, file, 98, 4, 3300);
			attr_dev(div8, "class", "w-4/12 px-4");
			add_location(div8, file, 97, 3, 3270);
			add_location(p4, file, 101, 4, 3377);
			attr_dev(div9, "class", "hidden w-4/12 px-4 sm:block");
			add_location(div9, file, 100, 3, 3331);
			add_location(p5, file, 104, 4, 3460);
			attr_dev(div10, "class", "flex justify-end w-8/12 px-4 sm:w-4/12");
			add_location(div10, file, 103, 3, 3403);
			attr_dev(div11, "class", "flex w-full ml-auto md:w-8/12");
			add_location(div11, file, 96, 2, 3223);
			attr_dev(header1, "class", "flex mb-2");
			add_location(header1, file, 95, 1, 3194);
			attr_dev(div12, "class", "w-full ml-auto md:w-8/12");
			add_location(div12, file, 109, 2, 3538);
			attr_dev(section1, "class", "flex flex-wrap");
			add_location(section1, file, 108, 1, 3503);
			add_location(p6, file, 127, 3, 4226);
			attr_dev(div13, "class", "w-8/12 px-4 sm:w-3/12");
			add_location(div13, file, 126, 2, 4187);
			add_location(p7, file, 131, 4, 4356);
			attr_dev(div14, "class", "hidden w-8/12 px-4 sm:block");
			add_location(div14, file, 130, 3, 4310);
			add_location(p8, file, 134, 4, 4449);
			attr_dev(div15, "class", "flex justify-end w-full px-4 sm:w-4/12");
			add_location(div15, file, 133, 3, 4392);
			attr_dev(div16, "class", "flex w-4/12 ml-auto sm:w-8/12");
			add_location(div16, file, 129, 2, 4263);
			attr_dev(div17, "class", "flex pt-8 mt-auto text-gray-600 md:pt-12 dark:text-gray-400");
			add_location(div17, file, 125, 1, 4111);
