...
const components = [
	{
		js: () => Promise.all([import('./index.c01278a7.js'), __inject_styles(["client-6979b1e4.css"])]).then(function(x) { return x[0]; })
	}
];
