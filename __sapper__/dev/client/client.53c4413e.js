...
const components = [
	{
		js: () => Promise.all([import('./index.030a1357.js'), __inject_styles(["client-ba3b4a0d.css"])]).then(function(x) { return x[0]; })
	}
];
