...
const components = [
	{
		js: () => Promise.all([import('./index.c47bc895.js'), __inject_styles(["client-b941cf2e.css"])]).then(function(x) { return x[0]; })
	}
];
