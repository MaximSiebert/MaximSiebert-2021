import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, v as validate_slots, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, h as detach_dev, j as claim_space, k as add_location, l as attr_dev, m as insert_dev, n as append_dev, o as set_data_dev, p as noop, q as validate_each_argument, r as create_component, u as query_selector_all, w as claim_component, x as mount_component, y as transition_in, z as transition_out, A as destroy_each, B as destroy_component } from './client.298c0077.js';
...
async function preload$1() {
	const getUpdatedDate = await this.fetch(`https://api.github.com/repos/MaximSiebert/MaximSiebert-2021/branches/gh-pages`);
	const updatedDate = await getUpdatedDate.json();
	return { updatedDate };
}
...
function instance$1($$self, $$props, $$invalidate) {
	...
	updateClock();
	const writable_props = ["updatedDate"];
	...
	return [time, year, updatedDate];
}

class Footer extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { updatedDate: 2 });
		...
		if (/*updatedDate*/ ctx[2] === undefined && !("updatedDate" in props)) {
			console_1.warn("<Footer> was created without expected prop 'updatedDate'");
		}
	}
