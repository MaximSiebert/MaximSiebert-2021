...
const components = [
	{
		js: () => Promise.all([import('./index.d6d3d3d4.js'), __inject_styles(["client-a61f71ff.css"])]).then(function(x) { return x[0]; })
	}
];
