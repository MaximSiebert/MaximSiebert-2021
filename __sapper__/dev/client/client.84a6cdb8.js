...
const components = [
	{
		js: () => Promise.all([import('./index.52b8cb2f.js'), __inject_styles(["client-2905d588.css"])]).then(function(x) { return x[0]; })
	}
];
