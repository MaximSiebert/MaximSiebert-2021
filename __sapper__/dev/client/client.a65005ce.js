...
const components = [
	{
		js: () => Promise.all([import('./index.35d8e5e8.js'), __inject_styles(["client-4b703a29.css"])]).then(function(x) { return x[0]; })
	}
];
