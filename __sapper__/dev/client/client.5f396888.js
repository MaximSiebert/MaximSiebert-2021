...
const components = [
	{
		js: () => Promise.all([import('./index.4dee0f33.js'), __inject_styles(["client-4b703a29.css"])]).then(function(x) { return x[0]; })
	}
];
