...
const components = [
	{
		js: () => Promise.all([import('./index.423af995.js'), __inject_styles(["client-30818844.css"])]).then(function(x) { return x[0]; })
	}
];
